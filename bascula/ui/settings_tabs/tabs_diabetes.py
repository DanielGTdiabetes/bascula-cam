...
def add_tab(screen, notebook):
    ...
    lbl_low = tk.Label(simple, text='BG baja (mg/dL)', bg=COL_CARD, fg=COL_TEXT)
    lbl_low.grid(row=0, column=0, sticky='w')
    ...
    lbl_high = tk.Label(simple, text='BG alta (mg/dL)', bg=COL_CARD, fg=COL_TEXT)
    lbl_high.grid(row=0, column=1, sticky='w', padx=(10,0))
    ...
    lbl_interval = tk.Label(simple, text='Intervalo (s)', bg=COL_CARD, fg=COL_TEXT)
    lbl_interval.grid(row=0, column=2, sticky='w', padx=(10,0))
    ...
    lbl_cd_low = tk.Label(cd_fr, text='Cooldown hipo (min)', bg=COL_CARD, fg=COL_TEXT)
    lbl_cd_low.grid(row=0, column=0, sticky='w')
    ...
    lbl_cd_high = tk.Label(cd_fr, text='Cooldown hiper (min)', bg=COL_CARD, fg=COL_TEXT)
    lbl_cd_high.grid(row=0, column=1, sticky='w', padx=(10,0))
