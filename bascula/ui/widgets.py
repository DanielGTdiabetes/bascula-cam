...
# TAMAÑOS OPTIMIZADOS PARA 1024x600 (HDMI 7")
FS_HUGE = 52           # Peso principal
FS_TITLE = 18          # Títulos principales
FS_CARD_TITLE = 16     # Títulos de cartas
FS_TEXT = 14           # Texto normal
FS_BTN = 16            # Botones
FS_BTN_SMALL = 14      
FS_ENTRY = 16          
FS_ENTRY_SMALL = 14    
FS_ENTRY_MICRO = 12    # Más pequeño para teclado compacto
FS_BTN_MICRO = 13      
...
class Card(tk.Frame):
    ...
    def __init__(self, parent, **kwargs):
        ...
        super().pack(padx=1, pady=1, fill="both", expand=True)
...
class GhostButton(tk.Button):
    ...
    def __init__(self, parent, text, command, small=False, micro=False, **kwargs):
        ...
        self.configure(
            ...
            bd=1, padx=12, pady=6, relief="solid",
...
class NumericKeypad(tk.Frame):
    """
    Teclado numérico ultra-compacto optimizado para 1024x600.
    Botones más pequeños y menos padding para que quepa todo visible.
    """
    def __init__(self, parent, textvar: tk.StringVar, on_ok=None, on_clear=None,
        ...
        # Tamaños ultra-compactos para 1024x600
        if variant == "ultracompact":
            f_entry = ("DejaVu Sans Mono", 11)  # Más pequeño
            f_btn = ("DejaVu Sans", 11, "bold") # Más pequeño
            pad_x = 2; pad_y = 1  # Mínimo padding
            btn_height = 1  # Altura mínima
        ...
        def mkbtn(txt, r, c, cmd=None, span=1, special=False):
            ...
            b = tk.Button(self, text=txt, command=cmd or (lambda t=txt: self._press(t)),
                          ...
                          font=f_btn, bd=0, relief="flat", height=btn_height)
        ...
        # Teclado numérico con diseño compacto
        ...
        # Configurar filas con altura mínima
        for r in range(1, 6):
            self.grid_rowconfigure(r, weight=1, minsize=25)  # Altura mínima
