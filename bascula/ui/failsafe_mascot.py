...
from .rpi_config import PRIMARY_COLORS
...
MASCOT_STATES: Dict[str, Dict[str, str]] = {
    "idle": {"color": "#4ADE80", "symbol": "♥"},
    "listening": {"color": "#22D3EE", "symbol": "♪"},
    "processing": {"color": "#A855F7", "symbol": "⟳"},
    "happy": {"color": "#EAB308", "symbol": "★"},
...
class MascotCanvas(tk.Canvas):
    ...
    def _build(self) -> None:
        ...
        self.screen = self.create_round_rect(x0 + 20, screen_y0, x1 - 20, screen_y1, 18, fill="#072B1E", outline="")
        eye_w = 34
        eye_h = 18
        eye_y = screen_y0 - 30
        eye_gap = 46
        ...
        self.symbol_text = self.create_text(cx, screen_y0 + screen_h // 2, text="♥", fill="#FDFEE8", font=("Inter", 48, "bold"))
