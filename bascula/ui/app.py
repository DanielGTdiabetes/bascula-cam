...
class BasculaAppTk:
    def __init__(self):
        ...
        # IMPORTANTE: _on_close existe más abajo
    ...
    # --- EXISTE Y CIERRA LIMPIO (soluciona AttributeError) ---
    def _on_close(self):
    ...
    def capture_image(self, label: str = "add_item"):
        ...
        # CameraService devuelve la ruta; si admite label lo ignoramos por ahora
