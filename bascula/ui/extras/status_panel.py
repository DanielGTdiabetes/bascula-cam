...
class StatusPanel(tk.Frame):
    ...
    def _card(self, parent, title, color_key):
        colors = {
            "danger": "#EF4444", "info":" #06B6D4", "accent":"#8B5CF6", "primary":"#2563EB"
        }
        col = colors.get(color_key, MT.primary)
        card = tk.Frame(parent, bg=MT.surface, bd=1, relief="solid",
        ...
        val = tk.Label(card, text="0.0", font=("Segoe UI", 14, "bold"), fg=col, bg=MT.surface)
        val.pack(padx=8, pady=6)
        card.val = val
        return card
